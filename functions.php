...
function cnbeta_scripts() {
	...
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap.min.css', array(), '5.2.1' );
	// wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap.bundle.min.js', array(), '5.2.1', true );
}
